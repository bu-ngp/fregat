...
CREATE TABLE `fregatsettings` (
  ...
  `fregatsettings_glavbuh_name` char(255) DEFAULT NULL COMMENT 'ФИО Главного бухгалтера',
...
CREATE TABLE `spismat` (
  `spismat_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Номер ведомости',
  `id_mol` smallint(5) unsigned NOT NULL COMMENT 'Материально-ответственное лицо',
  `spismat_date` date NOT NULL COMMENT 'Дата ведомости',
...
--
-- Dumping data for table `spismat`
--

LOCK TABLES `spismat` WRITE;
/*!40000 ALTER TABLE `spismat` DISABLE KEYS */;
/*!40000 ALTER TABLE `spismat` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `spismatmaterials` (
  ...
  `id_mattraffic` mediumint(8) unsigned NOT NULL COMMENT 'Материал',
...
--
-- Dumping data for table `spismatmaterials`
--

LOCK TABLES `spismatmaterials` WRITE;
/*!40000 ALTER TABLE `spismatmaterials` DISABLE KEYS */;
/*!40000 ALTER TABLE `spismatmaterials` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-04-27  9:28:13
