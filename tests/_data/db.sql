...
INSERT INTO `fregatsettings` VALUES (1,'БУ \"Нижневартовская городская поликлиника\"','it@mugp-nv.ru','БЛЮСОВА МАРИЯ ЕВСТИГНЕЕВНА','НИКИФОРОВА ГАЛИНА РАИЛЕВНА','БУ \"Нижневартовская городская поликлиника\"','Бюджетное учреждение Ханты-Мансийского автономного округа - Югры \"Нижневартовская городская поликлиника\"');
