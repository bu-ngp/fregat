...
DROP DATABASE IF EXISTS baseportal;
CREATE DATABASE baseportal CHARACTER SET utf8 COLLATE utf8_general_ci;
USE baseportal;
--
...
INSERT INTO `auth_item_child` VALUES ('Administrator','EmailConfigRole'),('Administrator','FregatAdmin'),('Administrator','GlaukAdmin'),('Administrator','PatientRemoveRole'),('Administrator','RoleOperator'),('Administrator','UserOperator'),('BasePreparatEdit','PreparatEdit'),('DocfilesEditRole','DocfilesEdit'),('EmailConfigRole','EmailConfig'),('EmployeeBuildEditRole','EmployeeBuildEdit'),('EmployeeSpecEditRole','EmployeeSpecEdit'),('FregatAdmin','FregatConfigRole'),('FregatAdmin','FregatImportOperator'),('FregatAdmin','FregatInstallEdit'),('FregatAdmin','FregatMaterialEdit'),('FregatAdmin','FregatMaterialMolDelete'),('FregatAdmin','FregatMolEdit'),('FregatAdmin','FregatOsmotraktEdit'),('FregatAdmin','FregatRecoveryEdit'),('FregatAdmin','FregatRemoveaktEdit'),('FregatAdmin','FregatSpravEdit'),('FregatAdmin','FregatUserRole'),('FregatAdmin','SpisosnovaktEditRole'),('FregatBuildEdit','BuildEdit'),('FregatConfigRole','FregatConfig'),('FregatDolzhEdit','DolzhEdit'),('FregatEmployeeEdit','EmployeeEdit'),('FregatGrupaEdit','GrupaEdit'),('FregatHozSister','FregatInstallEdit'),('FregatHozSister','FregatMolEdit'),('FregatHozSister','FregatOsmotraktEdit'),('FregatHozSister','FregatRecoveryEdit'),('FregatHozSister','FregatRemoveaktEdit'),('FregatHozSister','FregatUserPermission'),('FregatHozSister','SpisosnovaktEditRole'),('FregatImportOperator','FregatImport'),('FregatInstallEdit','InstallEdit'),('FregatIzmerEdit','IzmerEdit'),('FregatMaterialEdit','MaterialEdit'),('FregatMaterialMolDelete','MaterialMolDelete'),('FregatMatvidEdit','MatvidEdit'),('FregatMolEdit','MolEdit'),('FregatOrganEdit','OrganEdit'),('FregatOsmotraktEdit','OsmotraktEdit'),('FregatPodrazEdit','PodrazEdit'),('FregatReasonEdit','ReasonEdit'),('FregatRecoveryEdit','RecoveryEdit'),('FregatRemoveaktEdit','RemoveaktEdit'),('FregatSpravEdit','DocfilesEditRole'),('FregatSpravEdit','FregatBuildEdit'),('FregatSpravEdit','FregatDolzhEdit'),('FregatSpravEdit','FregatEmployeeEdit'),('FregatSpravEdit','FregatGrupaEdit'),('FregatSpravEdit','FregatIzmerEdit'),('FregatSpravEdit','FregatMatvidEdit'),('FregatSpravEdit','FregatOrganEdit'),('FregatSpravEdit','FregatPodrazEdit'),('FregatSpravEdit','FregatReasonEdit'),('FregatSpravEdit','SchetuchetEditRole'),('FregatUserRole','FregatUserPermission'),('GlaukAdmin','BasePreparatEdit'),('GlaukAdmin','GlaukOperatorRole'),('GlaukOperatorRole','GlaukOperatorPermission'),('GlaukOperatorRole','GlaukUserPermission'),('GlaukUserRole','GlaukUserPermission'),('PatientRemoveRole','PatientRemove'),('RoleOperator','RoleEdit'),('SchetuchetEditRole','SchetuchetEdit'),('SpisosnovaktEditRole','SpisosnovaktEdit'),('UserOperator','UserEdit');
...
INSERT INTO `fregatsettings` VALUES (1,'БУ \"Нижневартовская городская поликлиника\"','it@mugp-nv.ru');
...
INSERT INTO `importconfig` VALUES (1,'Upload_BGU_OC',2,'B','A','C','D','E','I','J','K','G','H','F','L','M','Upload_BGU_M3',2,'B','C','D','F','E','G','H','I','J','A','K','L',100,'Upload_Kamin',7200,3000000000,'A','B','C','D','E','F','G','H','I','J','Upload_BGU_OCgr',2,1,'K','L');
...
-- Dump completed on 2016-11-03 15:46:41
