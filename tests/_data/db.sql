...
--
-- Host: localhost    Database: baseportal
-- ------------------------------------------------------
...
CREATE TABLE `build` (
  ...
  `build_name` char(100) NOT NULL COMMENT 'Р—РґР°РЅРёРµ',
...
CREATE TABLE `cabinet` (
  ...
  `id_build` tinyint(1) unsigned DEFAULT NULL,
  `cabinet_name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`cabinet_id`),
  UNIQUE KEY `idx_cabinet` (`id_build`,`cabinet_name`),
  CONSTRAINT `cabinet_id_build` FOREIGN KEY (`id_build`) REFERENCES `build` (`build_id`) ON DELETE CASCADE
...
CREATE TABLE `class_mkb` (
  ...
  `name` varchar(512) NOT NULL COMMENT 'РќР°РёРјРµРЅРѕРІР°РЅРёРµ РґРёР°РіРЅРѕР·Р°',
  `code` varchar(20) NOT NULL COMMENT 'РљРѕРґ РњРљР‘10',
  `parent_id` int(11) DEFAULT NULL COMMENT 'Р’С‹С€РµСЃС‚РѕСЏС‰РёР№ РѕР±СЉРµРєС‚',
  `parent_code` varchar(20) DEFAULT NULL COMMENT 'РљРѕРґ РІС‹С€РµСЃС‚РѕСЏС‰РµРіРѕ РѕР±СЉРµРєС‚Р°',
  `node_count` smallint(6) NOT NULL DEFAULT '0' COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ РІР»РѕР¶РµРЅРЅС‹С… РІ С‚РµРєСѓС‰СѓСЋ РІРµС‚РєСѓ',
  `additional_info` text COMMENT 'Р”РѕРїРѕР»РЅРёС‚РµР»СЊРЅС‹Рµ РґР°РЅРЅС‹Рµ РїРѕ РґРёР°РіРЅРѕР·Сѓ',
  PRIMARY KEY (`id`),
  KEY `parent_id` (`parent_id`),
  KEY `parent_code` (`parent_code`),
  CONSTRAINT `class_mkb_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `class_mkb` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22769 DEFAULT CHARSET=utf8 COMMENT='РњРљР‘-10 РњРµР¶РґСѓРЅР°СЂРѕРґРЅС‹Р№ РєР»Р°СЃСЃРёС„РёРєР°С‚РѕСЂ Р±РѕР»РµР·РЅРµР№';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `docfiles` (
  ...
  `docfiles_name` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р°',
  `docfiles_hash` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р° РІ С„Р°Р№Р»РѕРІРѕР№ СЃРёСЃС‚РµРјРµ',
  `docfiles_ext` char(10) NOT NULL COMMENT 'Р Р°СЃС€РёСЂРµРЅРёРµ С„Р°Р№Р»Р°',
...
CREATE TABLE `dolzh` (
  ...
  `dolzh_name` char(100) NOT NULL COMMENT 'Р”РѕР»Р¶РЅРѕСЃС‚СЊ',
...
CREATE TABLE `employee` (
  `employee_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'РљРѕРґ СЃРїРµС†РёР°Р»СЊРЅРѕСЃС‚Рё',
  `id_dolzh` smallint(5) unsigned NOT NULL COMMENT 'Р”РѕР»Р¶РЅРѕСЃС‚СЊ',
  `id_podraz` smallint(5) unsigned NOT NULL COMMENT 'РџРѕРґСЂР°Р·РґРµР»РµРЅРёРµ',
  `id_build` tinyint(3) unsigned DEFAULT NULL COMMENT 'Р—РґР°РЅРёРµ',
  `id_person` smallint(5) unsigned DEFAULT NULL COMMENT 'РЎРѕС‚СЂСѓРґРЅРёРє',
  `employee_username` char(128) NOT NULL COMMENT 'РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ РёР·РјРµРЅРёРІС€РёР№ Р·Р°РїРёСЃСЊ',
  `employee_lastchange` datetime NOT NULL COMMENT 'Р”Р°С‚Р° РёР·РјРµРЅРµРЅРёСЏ Р·Р°РїРёСЃРё',
  `employee_dateinactive` date DEFAULT NULL COMMENT 'Р”Р°С‚Р° СЃ РєРѕС‚РѕСЂРѕР№ СЃРїРµС†РёР°Р»СЊРЅРѕСЃС‚СЊ РЅРµР°РєС‚РёРІРЅР°',
  `employee_forinactive` tinyint(1) unsigned DEFAULT NULL COMMENT 'РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РїСЂРё РёРјРїРѕСЂС‚Рµ СЃРѕС‚СЂСѓРґРЅРёРєРѕРІ',
  `employee_importdo` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT 'Р—Р°РїРёСЃСЊ РёР·РјРµРЅСЏРµРјР° РїСЂРё РёРјРїРѕСЂС‚РёСЂРѕРІР°РЅРёРё',
...
CREATE TABLE `employeelog` (
  ...
  `employeelog_filename` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р°',
  `employeelog_filelastdate` datetime DEFAULT NULL COMMENT 'Р”Р°С‚Р° РёР·РјРµРЅРµРЅРёСЏ С„Р°Р№Р»Р°',
  `employeelog_rownum` mediumint(9) NOT NULL COMMENT 'РќРѕРјРµСЂ СЃС‚СЂРѕРєРё',
  `employeelog_type` tinyint(1) NOT NULL COMMENT 'РўРёРї СЃРѕРѕР±С‰РµРЅРёСЏ',
  `employeelog_message` varchar(1000) NOT NULL COMMENT 'РЎРѕРѕР±С‰РµРЅРёРµ',
  `employee_fio` char(255) DEFAULT NULL COMMENT 'Р¤РРћ СЃРѕС‚СЂСѓРґРЅРёРєР°',
  `dolzh_name` char(255) DEFAULT NULL COMMENT 'Р”РѕР»Р¶РЅРѕСЃС‚СЊ',
  `podraz_name` char(255) DEFAULT NULL COMMENT 'РџРѕРґСЂР°Р·РґРµР»РµРЅРёРµ',
  `build_name` char(255) DEFAULT NULL COMMENT 'Р—РґР°РЅРёРµ',
...
) ENGINE=InnoDB AUTO_INCREMENT=38467 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fregatsettings` (
  ...
  `fregatsettings_recoverysend_emailtheme` char(255) DEFAULT NULL COMMENT 'РўРµРјР° СЌР»РµРєС‚СЂРѕРЅРЅРѕРіРѕ РїРёСЃСЊРјР°',
  `fregatsettings_recoverysend_emailfrom` char(255) DEFAULT NULL COMMENT 'Р­Р»РµРєС‚СЂРѕРЅРЅР°СЏ РїРѕС‡С‚Р°, РѕС‚ РєРѕС‚РѕСЂРѕР№ РѕС‚РїСЂР°РІР»СЏРµС‚СЃСЏ РїРёСЃСЊРјРѕ',
  `fregatsettings_glavvrach_name` char(255) DEFAULT NULL COMMENT 'Р¤РРћ Р“Р»Р°РІРЅРѕРіРѕ РІСЂР°С‡Р°',
  `fregatsettings_glavbuh_name` char(255) DEFAULT NULL COMMENT 'Р¤РРћ Р“Р»Р°РІРЅРѕРіРѕ Р±СѓС…РіР°Р»С‚РµСЂР°',
  `fregatsettings_uchrezh_namesokr` char(255) DEFAULT NULL COMMENT 'РЎРѕРєСЂР°С‰РµРЅРЅРѕРµ РЅР°РёРјРµРЅРѕРІР°РЅРёРµ СѓС‡СЂРµР¶РґРµРЅРёСЏ',
  `fregatsettings_uchrezh_name` char(255) DEFAULT NULL COMMENT 'РџРѕР»РЅРѕРµ РЅР°РёРјРµРЅРѕРІР°РЅРёРµ СѓС‡СЂРµР¶РґРµРЅРёСЏ',
  `fregatsettings_employee_inactive_hidden` tinyint(1) DEFAULT NULL,
...
INSERT INTO `fregatsettings` VALUES (1,'БУ \"Нижневартовская городская поликлиника\"','it@mugp-nv.ru','БЛЮСОВА МАРИЯ ЕВСТИГНЕЕВНА','НИКИФОРОВА ГАЛИНА РАИЛЕВНА','БУ \"Нижневартовская городская поликлиника\"','Бюджетное учреждение Ханты-Мансийского автономного округа - Югры \"Нижневартовская городская поликлиника\"',1);
...
CREATE TABLE `glaukuchet` (
  ...
  `glaukuchet_uchetbegin` date NOT NULL COMMENT 'Р”Р°С‚Р° РїРѕСЃС‚Р°РЅРѕРІРєРё РЅР° СѓС‡РµС‚',
  `glaukuchet_detect` tinyint(1) unsigned NOT NULL COMMENT 'Р’РёРґ РІС‹СЏРІР»РµРЅРёСЏ Р·Р°Р±РѕР»РµРІР°РЅРёСЏ',
  `glaukuchet_deregdate` date DEFAULT NULL COMMENT 'Р”Р°С‚Р° СЃРЅСЏС‚РёСЏ СЃ СѓС‡РµС‚Р°',
  `glaukuchet_deregreason` tinyint(1) unsigned DEFAULT NULL COMMENT 'РџСЂРёС‡РёРЅР° СЃРЅСЏС‚РёСЏ СЃ СѓС‡РµС‚Р°',
  `glaukuchet_stage` tinyint(1) unsigned NOT NULL COMMENT 'РЎС‚Р°РґРёСЏ РіР»Р°СѓРєРѕРјС‹',
  `glaukuchet_operdate` date DEFAULT NULL COMMENT 'Р”Р°С‚Р° РїРѕСЃР»РµРґРЅРµРіРѕ РѕРїРµСЂР°С‚РёРІРЅРѕРіРѕ Р»РµС‡РµРЅРёСЏ',
  `glaukuchet_invalid` tinyint(1) unsigned DEFAULT NULL COMMENT 'Р“СЂСѓРїРїР° РёРЅРІР°Р»РёРґРЅРѕСЃС‚Рё',
  `glaukuchet_lastvisit` date NOT NULL COMMENT 'Р”Р°С‚Р° РїРѕСЃР»РµРґРЅРµР№ СЏРІРєРё РЅР° РїСЂРёРµРј',
  `glaukuchet_lastmetabol` date DEFAULT NULL COMMENT 'Р”Р°С‚Р° РїРѕСЃР»РµРґРЅРµРіРѕ РєСѓСЂСЃР° РјРµС‚РѕР±РѕР»РёС‡РµСЃРєРѕР№ С‚РµСЂР°РїРёРё',
  `id_patient` mediumint(8) unsigned NOT NULL COMMENT 'РџР°С†РёРµРЅС‚',
  `id_employee` smallint(5) unsigned NOT NULL COMMENT 'Р’СЂР°С‡',
  `id_class_mkb` int(11) NOT NULL COMMENT 'Р”РёР°РіРЅРѕР·',
  `glaukuchet_comment` varchar(512) DEFAULT NULL COMMENT 'Р—Р°РјРµС‚РєР°',
  `glaukuchet_username` char(128) NOT NULL COMMENT 'РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ РёР·РјРµРЅРёРІС€РёР№ Р·Р°РїРёСЃСЊ',
  `glaukuchet_lastchange` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Р”Р°С‚Р° РёР·РјРµРЅРµРЅРёСЏ Р·Р°РїРёСЃРё',
...
CREATE TABLE `glprep` (
  ...
  `id_glaukuchet` mediumint(8) unsigned NOT NULL COMMENT 'РљР°СЂС‚Р° РіР»Р°СѓРєРѕРјРЅРѕРіРѕ Р±РѕР»СЊРЅРѕРіРѕ',
  `id_preparat` smallint(5) unsigned NOT NULL COMMENT 'РџСЂРµРїР°СЂР°С‚',
  `glprep_rlocat` tinyint(1) unsigned DEFAULT NULL COMMENT 'РљР°С‚РµРіРѕСЂРёСЏ Р»СЊРіРѕС‚РЅРѕРіРѕ Р»РµРєР°СЂСЃС‚РІРµРЅРЅРѕРіРѕ РѕР±РµСЃРїРµС‡РµРЅРёСЏ',
...
CREATE TABLE `impemployee` (
  ...
  `id_employee` smallint(5) unsigned NOT NULL COMMENT 'РЎРѕС‚СЂСѓРґРЅРёРє',
...
CREATE TABLE `importconfig` (
  ...
  `os_filename` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ (.xls РІ РґРёСЂРµРєС‚РѕСЂРёРё "imp")',
  `os_startrow` smallint(6) NOT NULL DEFAULT '1' COMMENT 'РќРѕРјРµСЂ СЃС‚СЂРѕРєРё С„Р°Р№Р»Р° Excel, СЃ РєРѕС‚РѕСЂРѕР№ СЃС‡РёС‚С‹РІР°СЋС‚СЃСЏ РѕСЃРЅРѕРІРЅС‹Рµ СЃСЂРµРґСЃС‚РІР°',
  `os_material_1c` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РљРѕРґ 1РЎ" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_mattraffic_date` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РџРµСЂРёРѕРґ" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_material_inv` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РРЅРІРµРЅС‚Р°СЂРЅС‹Р№ РЅРѕРјРµСЂ" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_material_name1c` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РќР°РёРјРµРЅРѕРІР°РЅРёРµ" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_material_price` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р¦РµРЅР°" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_employee_fio` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р¤РРћ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_dolzh_name` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р”РѕР»Р¶РЅРѕСЃС‚СЊ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_podraz_name` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РџРѕРґСЂР°Р·РґРµР»РµРЅРёРµ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_material_serial` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РЎРµСЂРёР№РЅС‹Р№ РЅРѕРјРµСЂ" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_material_release` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р”Р°С‚Р° РІС‹РїСѓСЃРєР°" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_material_status` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РЎРѕСЃС‚РѕСЏРЅРёРµ" РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `os_material_schetuchet_kod` char(5) NOT NULL,
  `os_material_schetuchet_name` char(5) NOT NULL,
  `mat_filename` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р° РјР°С‚РµСЂРёР°Р»РѕРІ (.xls РІ РґРёСЂРµРєС‚РѕСЂРёРё "imp")',
  `mat_startrow` smallint(6) NOT NULL DEFAULT '1' COMMENT 'РќРѕРјРµСЂ СЃС‚СЂРѕРєРё С„Р°Р№Р»Р° Excel, СЃ РєРѕС‚РѕСЂРѕР№ СЃС‡РёС‚С‹РІР°СЋС‚СЃСЏ РјР°С‚РµСЂРёР°Р»С‹',
  `mat_material_1c` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РљРѕРґ 1РЎ" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_material_inv` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РРЅРІРµРЅС‚Р°СЂРЅС‹Р№ РЅРѕРјРµСЂ" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_material_name1c` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РќР°РёРјРµРЅРѕРІР°РЅРёРµ" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_material_number` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РљРѕР»РёС‡РµСЃС‚РІРѕ" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_izmer_name` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р•РґРёРЅРёС†Р° РёР·РјРµСЂРµРЅРёСЏ" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_material_price` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РЎС‚РѕРёРјРѕСЃС‚СЊ" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_employee_fio` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р¤РРћ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_dolzh_name` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р”РѕР»Р¶РЅРѕСЃС‚СЊ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_podraz_name` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РџРѕРґСЂР°Р·РґРµР»РµРЅРёРµ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РјР°С‚РµСЂРёР°Р»РѕРІ',
  `mat_material_tip_nomenklaturi` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РўРёРї РЅРѕРјРµРЅРєР»Р°С‚СѓСЂС‹" РјР°С‚РµСЂРёР°Р»РѕРІ',
  ...
  `logreport_reportcount` smallint(6) NOT NULL COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ С…СЂР°РЅСЏС‰РёС…СЃСЏ РѕС‚С‡РµС‚РѕРІ РёРјРїРѕСЂС‚Р°',
  `emp_filename` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р° СЃРѕС‚СЂСѓРґРЅРёРєРѕРІ (.txt РІ РґРёСЂРµРєС‚РѕСЂРёРё "imp")',
  `max_execution_time` smallint(6) NOT NULL COMMENT 'РњР°РєСЃРёРјР°Р»СЊРЅРѕРµ РІСЂРµРјСЏ РІС‹РїРѕР»РЅРµРЅРёСЏ Р·Р°РіСЂСѓР·РєРё С„Р°Р№Р»РѕРІ РёРјРїРѕСЂС‚Р° (РІ СЃРµРєСѓРЅРґР°С…)',
  `memory_limit` bigint(20) NOT NULL COMMENT 'РњР°РєСЃРёРјР°Р»СЊРЅРѕРµ РїРѕС‚СЂРµР±Р»РµРЅРёРµ РѕРїРµСЂР°С‚РёРІРЅРѕР№ РїР°РјСЏС‚Рё РїСЂРё РёРјРїРѕСЂС‚Рµ (РІ Р‘Р°Р№С‚Р°С…)',
  `gu_material_1c` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РљРѕРґ 1РЎ" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_material_inv` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РРЅРІРµРЅС‚Р°СЂРЅС‹Р№ РЅРѕРјРµСЂ" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_material_name1c` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РќР°РёРјРµРЅРѕРІР°РЅРёРµ" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_material_serial` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РЎРµСЂРёР№РЅС‹Р№ РЅРѕРјРµСЂ" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_material_release` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р”Р°С‚Р° РІС‹РїСѓСЃРєР°" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_material_number` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РљРѕР»РёС‡РµСЃС‚РІРѕ" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_material_price` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р¦РµРЅР°" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_podraz_name` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "РџРѕРґСЂР°Р·РґРµР»РµРЅРёРµ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_employee_fio` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р¤РРћ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_dolzh_name` char(5) NOT NULL COMMENT 'РџРѕР·РёС†РёСЏ РєРѕР»РѕРЅРєРё "Р”РѕР»Р¶РЅРѕСЃС‚СЊ РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРіРѕ Р»РёС†Р°" РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `gu_filename` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р° РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ (.xlsx РІ РґРёСЂРµРєС‚РѕСЂРёРё "imp")',
  `gu_startrow` smallint(6) NOT NULL COMMENT 'РќРѕРјРµСЂ СЃС‚СЂРѕРєРё С„Р°Р№Р»Р° Excel, СЃ РєРѕС‚РѕСЂРѕР№ СЃС‡РёС‚С‹РІР°РµС‚СЃСЏ РіСЂСѓРїРїРѕРІРѕР№ СѓС‡РµС‚ РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `importconfig_do` tinyint(1) NOT NULL COMMENT 'Р’РєР»СЋС‡РёС‚СЊ РёРјРїРѕСЂС‚ С„Р°Р№Р»РѕРІ РёР· 1РЎ',
...
CREATE TABLE `importemployee` (
  ...
  `importemployee_combination` char(255) NOT NULL COMMENT 'РЎР»РѕРІРѕСЃРѕС‡РµС‚Р°РЅРёРµ',
  `id_build` tinyint(3) unsigned DEFAULT NULL COMMENT 'Р—РґР°РЅРёРµ',
  `id_podraz` smallint(5) unsigned DEFAULT NULL COMMENT 'РџРѕРґСЂР°Р·РґРµР»РµРЅРёРµ',
...
CREATE TABLE `importmaterial` (
  ...
  `importmaterial_combination` char(255) NOT NULL COMMENT 'РЎР»РѕРІРѕСЃРѕС‡РµС‚Р°РЅРёРµ',
  `id_matvid` smallint(5) unsigned NOT NULL COMMENT 'Р’РёРґ',
...
CREATE TABLE `islist` (
  ...
  `islist_title` varchar(130) NOT NULL,
  `islist_text` text,
  `islist_ico` varchar(150) DEFAULT '',
  `islist_targeturl` varchar(255) NOT NULL,
...
CREATE TABLE `izmer` (
  ...
  `izmer_name` char(255) NOT NULL,
  `izmer_kod_okei` char(10) DEFAULT NULL COMMENT 'РљРѕРґ РћРљР•Р',
...
CREATE TABLE `logreport` (
  ...
  `logreport_date` date NOT NULL COMMENT 'Р”Р°С‚Р° РёРјРїРѕСЂС‚Р°',
  `logreport_errors` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ РѕС€РёР±РѕРє',
  `logreport_updates` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Р—Р°РїРёСЃРµР№ РёР·РјРµРЅРµРЅРѕ',
  `logreport_additions` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Р—Р°РїРёСЃРµР№ РґРѕР±Р°РІР»РµРЅРѕ',
  `logreport_amount` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ Р·Р°РїРёСЃРµР№',
  `logreport_missed` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Р—Р°РїРёСЃРµР№ РїСЂРѕРїСѓС‰РµРЅРѕ',
  `logreport_executetime` time DEFAULT NULL COMMENT 'Р’СЂРµРјСЏ РІС‹РїРѕР»РЅРµРЅРёСЏ РёРјРїРѕСЂС‚Р°',
  `logreport_employeelastdate` datetime DEFAULT NULL COMMENT 'Р”Р°С‚Р° РїРѕСЃР»РµРґРЅРµРіРѕ РёР·РјРµРЅРµРЅРёСЏ С„Р°Р№Р»Р° РґР»СЏ РёРјРїРѕСЂС‚Р° СЃРѕС‚СЂСѓРґРЅРёРєРѕРІ',
  `logreport_oslastdate` datetime DEFAULT NULL COMMENT 'Р”Р°С‚Р° РїРѕСЃР»РµРґРЅРµРіРѕ РёР·РјРµРЅРµРЅРёСЏ С„Р°Р№Р»Р° РґР»СЏ РёРјРїРѕСЂС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `logreport_matlastdate` datetime DEFAULT NULL COMMENT 'Р”Р°С‚Р° РїРѕСЃР»РµРґРЅРµРіРѕ РёР·РјРµРЅРµРЅРёСЏ С„Р°Р№Р»Р° РґР»СЏ РёРјРїРѕСЂС‚Р° РјР°С‚РµСЂРёР°Р»РѕРІ',
  `logreport_gulastdate` datetime DEFAULT NULL COMMENT 'Р”Р°С‚Р° РїРѕСЃР»РµРґРЅРµРіРѕ РёР·РјРµРЅРµРЅРёСЏ С„Р°Р№Р»Р° РґР»СЏ РёРјРїРѕСЂС‚Р° РіСЂСѓРїРїРѕРІРѕРіРѕ СѓС‡РµС‚Р° РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `logreport_memoryused` bigint(20) unsigned DEFAULT '0' COMMENT 'Р’С‹РґРµР»РµРЅРѕ РїР°РјСЏС‚Рё',
...
CREATE TABLE `material` (
  ...
  `material_name` varchar(500) DEFAULT NULL COMMENT 'РќР°РёРјРµРЅРѕРІР°РЅРёРµ',
  `material_name1c` varchar(500) NOT NULL COMMENT 'РќР°РёРјРµРЅРѕРІР°РЅРёРµ (РР· 1РЎ)',
  `material_1c` char(20) DEFAULT NULL COMMENT 'РљРѕРґ 1РЎ',
  `material_inv` char(50) NOT NULL COMMENT 'РРЅРІРµРЅС‚Р°СЂРЅС‹Р№ РЅРѕРјРµСЂ',
  `material_serial` char(255) DEFAULT NULL COMMENT 'РЎРµСЂРёР№РЅС‹Р№ РЅРѕРјРµСЂ',
  `material_release` date DEFAULT NULL COMMENT 'Р”Р°С‚Р° РІС‹РїСѓСЃРєР°',
  `material_number` decimal(12,3) unsigned NOT NULL DEFAULT '1.000' COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ',
  `material_price` decimal(12,2) unsigned DEFAULT NULL COMMENT 'РЎС‚РѕРёРјРѕСЃС‚СЊ',
  `material_tip` tinyint(1) unsigned NOT NULL COMMENT 'РўРёРї',
  `material_writeoff` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'РЎРїРёСЃР°РЅ',
  `id_matvid` smallint(5) unsigned NOT NULL COMMENT 'Р’РёРґ',
  `id_izmer` tinyint(3) unsigned NOT NULL COMMENT 'Р•РґРёРЅРёС†Р° РёР·РјРµСЂРµРЅРёСЏ',
  `material_username` char(128) NOT NULL COMMENT 'РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ РёР·РјРµРЅРёРІС€РёР№ Р·Р°РїРёСЃСЊ',
  `material_lastchange` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Р”Р°С‚Р° РёР·РјРµРЅРµРЅРёСЏ Р·Р°РїРёСЃРё',
  `material_importdo` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT 'Р—Р°РїРёСЃСЊ РёР·РјРµРЅСЏРµРјР° РїСЂРё РёРјРїРѕСЂС‚РёСЂРѕРІР°РЅРёРё',
  `id_schetuchet` smallint(5) unsigned DEFAULT NULL COMMENT 'Счет учета',
  `material_comment` varchar(512) DEFAULT NULL COMMENT 'Р—Р°РјРµС‚РєР°',
...
CREATE TABLE `matlog` (
  ...
  `id_logreport` int(10) unsigned NOT NULL,
  `matlog_filename` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р°',
  `matlog_filelastdate` datetime DEFAULT NULL COMMENT 'Р”Р°С‚Р° РёР·РјРµРЅРµРЅРёСЏ С„Р°Р№Р»Р°',
  `matlog_rownum` mediumint(8) unsigned NOT NULL COMMENT 'РќРѕРјРµСЂ СЃС‚СЂРѕРєРё',
  `matlog_type` tinyint(1) NOT NULL COMMENT 'РўРёРї СЃРѕРѕР±С‰РµРЅРёСЏ',
  `matlog_message` varchar(1000) NOT NULL COMMENT 'РЎРѕРѕР±С‰РµРЅРёРµ',
  `material_name1c` varchar(400) DEFAULT NULL COMMENT 'РќР°РёРјРµРЅРѕРІР°РЅРёРµ (РР· 1РЎ)',
  `material_1c` char(255) DEFAULT NULL COMMENT 'РљРѕРґ 1РЎ',
  `material_inv` char(255) DEFAULT NULL COMMENT 'РРЅРІРµРЅС‚Р°СЂРЅС‹Р№ РЅРѕРјРµСЂ',
  `material_serial` char(255) DEFAULT NULL COMMENT 'РЎРµСЂРёР№РЅС‹Р№ РЅРѕРјРµСЂ',
  `material_release` char(255) DEFAULT NULL COMMENT 'Р”Р°С‚Р° РІС‹РїСѓСЃРєР°',
  `material_number` char(255) DEFAULT NULL COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ',
  `material_price` char(255) DEFAULT NULL COMMENT 'Р¦РµРЅР°',
  `material_tip` char(255) DEFAULT NULL COMMENT 'РўРёРї',
  `material_writeoff` char(255) DEFAULT NULL COMMENT 'РЎС‚Р°С‚СѓСЃ СЃРїРёСЃР°РЅРёСЏ',
  `izmer_name` char(255) DEFAULT NULL COMMENT 'Р•РґРёРЅРёС†Р° РёР·РјРµСЂРµРЅРёСЏ',
  `izmer_kod_okei` char(255) DEFAULT NULL COMMENT 'РљРѕРґ РћРљР•Р РµРґРёРЅРёС†С‹ РёР·РјРµСЂРµРЅРёСЏ',
  `matvid_name` char(255) DEFAULT NULL COMMENT 'Р’РёРґ',
  `schetuchet_kod` char(255) DEFAULT NULL COMMENT 'РљРѕРґ СЃС‡РµС‚Р° СѓС‡РµС‚Р°',
  `schetuchet_name` char(255) DEFAULT NULL COMMENT 'РќР°РёРјРµРЅРѕРІР°РЅРёРµ СЃС‡РµС‚Р° СѓС‡РµС‚Р°',
...
CREATE TABLE `mattraffic` (
  ...
  `mattraffic_date` date NOT NULL COMMENT 'Р”Р°С‚Р° РѕРїРµСЂР°С†РёРё',
  `mattraffic_number` decimal(12,3) unsigned NOT NULL DEFAULT '1.000' COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ (Р—Р°РґРµР№СЃС‚РІРѕРІР°РЅРЅРѕРµ РІ РѕРїРµСЂР°С†РёРё)',
  `id_material` mediumint(8) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»СЊРЅР°СЏ С†РµРЅРЅРѕСЃС‚СЊ',
  `id_mol` smallint(5) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРµ Р»РёС†Рѕ',
  `mattraffic_username` char(128) NOT NULL COMMENT 'РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ РёР·РјРµРЅРёРІС€РёР№ Р·Р°РїРёСЃСЊ',
  `mattraffic_lastchange` datetime NOT NULL COMMENT 'Р”Р°С‚Р° РёР·РјРµРЅРµРЅРёСЏ Р·Р°РїРёСЃРё',
  `mattraffic_tip` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT 'РўРёРї РѕРїРµСЂР°С†РёРё',
  `mattraffic_forimport` tinyint(1) unsigned DEFAULT NULL COMMENT 'РСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РїСЂРё РёРјРїРѕСЂС‚Рµ РјР°С‚РµСЂРёР°Р»СЊРЅС‹С… С†РµРЅРЅРѕСЃС‚РµР№',
...
) ENGINE=InnoDB AUTO_INCREMENT=30661 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `matvid` (
  ...
  `matvid_name` char(255) NOT NULL COMMENT 'Р’РёРґ',
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `naklad` (
  `naklad_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'РР” РўСЂРµР±РѕРІР°РЅРёСЏ-РЅР°РєР»Р°РґРЅРѕР№',
  `naklad_date` date NOT NULL COMMENT 'Р”Р°С‚Р°',
  `id_mol_release` smallint(5) unsigned NOT NULL COMMENT 'РњРћР›, РєС‚Рѕ РѕС‚РїСѓСЃС‚РёР»',
  `id_mol_got` smallint(5) unsigned NOT NULL COMMENT 'РњРћР›, РєС‚Рѕ Р·Р°С‚СЂРµР±РѕРІР°Р»',
...
CREATE TABLE `nakladmaterials` (
  `nakladmaterials_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'РР”',
  `id_naklad` mediumint(8) unsigned NOT NULL COMMENT 'РўСЂРµР±РѕРІР°РЅРёРµ-РЅР°РєР»Р°РґРЅР°СЏ',
  `id_mattraffic` mediumint(8) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»СЊРЅР°СЏ С†РµРЅРЅРѕСЃС‚СЊ',
  `nakladmaterials_number` decimal(12,3) NOT NULL COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ',
...
CREATE TABLE `organ` (
  ...
  `organ_name` char(255) NOT NULL COMMENT 'РћСЂРіР°РЅРёР·Р°С†РёСЏ',
  `organ_email` char(255) DEFAULT NULL COMMENT 'Р­Р»РµРєС‚СЂРѕРЅРЅР°СЏ РїРѕС‡С‚Р° РѕСЂРіР°РЅРёР·Р°С†РёРё',
  `organ_phones` char(255) DEFAULT NULL COMMENT 'РўРµР»РµС„РѕРЅС‹ РѕСЂРіР°РЅРёР·Р°С†РёРё',
...
CREATE TABLE `osmotrakt` (
  `osmotrakt_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'РќРѕРјРµСЂ Р°РєС‚Р° РѕСЃРјРѕС‚СЂР°',
  `osmotrakt_comment` varchar(400) DEFAULT NULL COMMENT 'РћРїРёСЃР°РЅРёРµ РїСЂРёС‡РёРЅС‹ РЅРµРёСЃРїСЂР°РІРЅРѕСЃС‚Рё',
  `id_reason` smallint(5) unsigned DEFAULT NULL COMMENT 'РџСЂРёС‡РёРЅР° РЅРµРёСЃРїСЂР°РІРЅРѕСЃС‚Рё',
  `id_user` smallint(5) unsigned NOT NULL COMMENT 'Р­РєСЃРїР»СѓР°С‚Р°С‚РѕСЂ РјР°С‚РµСЂРёР°Р»СЊРЅРѕР№ С†РµРЅРЅРѕСЃС‚Рё',
  `id_master` smallint(5) unsigned NOT NULL COMMENT 'РЎРѕСЃС‚Р°РІРёС‚РµР»СЊ Р°РєС‚Р°',
  `osmotrakt_date` date NOT NULL COMMENT 'Р”Р°С‚Р° РѕСЃРјРѕС‚СЂР° РјР°С‚РµСЂРёР°Р»СЊРЅРѕР№ С†РµРЅРЅРѕСЃС‚Рё',
  `id_tr_osnov` mediumint(8) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»СЊРЅР°СЏ С†РµРЅРЅРѕСЃС‚СЊ',
...
CREATE TABLE `osmotraktmat` (
  `osmotraktmat_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'РќРѕРјРµСЂ Р°РєС‚Р° РѕСЃРјРѕС‚СЂР°',
  `osmotraktmat_date` date NOT NULL COMMENT 'Р”Р°С‚Р° РѕСЃРјРѕС‚СЂР° РјР°С‚РµСЂРёР°Р»Р°',
  `id_master` smallint(5) unsigned NOT NULL COMMENT 'РЎРѕСЃС‚Р°РІРёС‚РµР»СЊ Р°РєС‚Р°',
...
CREATE TABLE `patient` (
  ...
  `patient_fam` char(255) NOT NULL COMMENT 'Р¤Р°РјРёР»РёСЏ',
  `patient_im` char(255) NOT NULL COMMENT 'РРјСЏ',
  `patient_ot` char(255) DEFAULT NULL COMMENT 'РћС‚С‡РµСЃС‚РІРѕ',
  `patient_dr` date NOT NULL COMMENT 'Р”Р°С‚Р° СЂРѕР¶РґРµРЅРёСЏ',
  `patient_pol` tinyint(1) unsigned NOT NULL COMMENT 'РџРѕР»',
  `id_fias` char(36) DEFAULT NULL COMMENT 'РђРґСЂРµСЃ',
  `patient_dom` char(10) DEFAULT NULL COMMENT 'Р”РѕРј',
  `patient_korp` char(10) DEFAULT NULL COMMENT 'РљРѕСЂРїСѓСЃ',
  `patient_kvartira` char(10) DEFAULT NULL COMMENT 'РљРІР°СЂС‚РёСЂР°',
  `patient_username` char(128) NOT NULL COMMENT 'РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ РёР·РјРµРЅРёРІС€РёР№ Р·Р°РїРёСЃСЊ',
  `patient_lastchange` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Р”Р°С‚Р° РёР·РјРµРЅРµРЅРёСЏ Р·Р°РїРёСЃРё',
...
CREATE TABLE `podraz` (
  ...
  `podraz_name` char(255) NOT NULL COMMENT 'РџРѕРґСЂР°Р·РґРµР»РµРЅРёРµ',
...
CREATE TABLE `preparat` (
  ...
  `preparat_name` char(255) NOT NULL COMMENT 'РќР°РёРјРµРЅРѕРІР°РЅРёРµ РїСЂРµРїР°СЂР°С‚Р°',
...
CREATE TABLE `profile` (
  ...
  `profile_inn` char(12) DEFAULT NULL COMMENT 'РРќРќ',
  `profile_dr` date DEFAULT NULL COMMENT 'Р”Р°С‚Р° СЂРѕР¶РґРµРЅРёСЏ',
  `profile_pol` tinyint(1) DEFAULT NULL COMMENT 'РџРѕР»',
  `profile_address` varchar(400) DEFAULT NULL COMMENT 'РђРґСЂРµСЃ',
  `profile_snils` char(11) DEFAULT NULL COMMENT 'РЎРќРР›РЎ',
...
CREATE TABLE `reason` (
  ...
  `reason_text` varchar(400) NOT NULL COMMENT 'РџСЂРёС‡РёРЅР° РЅРµРёСЃРїСЂР°РІРЅРѕСЃС‚Рё',
...
CREATE TABLE `recoveryrecieveakt` (
  ...
  `id_osmotrakt` mediumint(8) unsigned NOT NULL COMMENT 'РђРєС‚ РѕСЃРјРѕС‚СЂР°',
  `id_recoverysendakt` smallint(5) unsigned NOT NULL COMMENT 'РђРєС‚ РѕС‚РїСЂР°РІРєРё РЅР° РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёРµ',
  `recoveryrecieveakt_result` char(255) DEFAULT NULL COMMENT 'Р РµР·СѓР»СЊС‚Р°С‚ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёСЏ',
  `recoveryrecieveakt_repaired` tinyint(1) DEFAULT NULL COMMENT 'РџРѕРґР»РµР¶РёС‚ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёСЋ',
  `recoveryrecieveakt_date` date DEFAULT NULL COMMENT 'Р”Р°С‚Р° РїРѕР»СѓС‡РµРЅРёСЏ',
...
CREATE TABLE `recoveryrecieveaktmat` (
  ...
  `recoveryrecieveaktmat_result` char(255) DEFAULT NULL COMMENT 'Р РµР·СѓР»СЊС‚Р°С‚ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёСЏ',
  `recoveryrecieveaktmat_repaired` tinyint(1) DEFAULT NULL COMMENT 'РџРѕРґР»РµР¶РёС‚ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёСЋ',
  `recoveryrecieveaktmat_date` date DEFAULT NULL COMMENT 'Р”Р°С‚Р° РїРѕР»СѓС‡РµРЅРёСЏ',
  `id_recoverysendakt` smallint(5) unsigned NOT NULL COMMENT 'РђРєС‚ РѕС‚РїСЂР°РІРєРё РЅР° РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёРµ',
  `id_tr_mat_osmotr` mediumint(8) unsigned NOT NULL COMMENT 'РђРєС‚ РѕСЃРјРѕС‚СЂР° РјР°С‚РµСЂРёР°Р»Р°',
...
CREATE TABLE `recoverysendakt` (
  `recoverysendakt_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'РќРѕРјРµСЂ Р°РєС‚Р° РѕС‚РїСЂР°РІРєРё',
  `recoverysendakt_date` date NOT NULL COMMENT 'Р”Р°С‚Р° РѕС‚РїСЂР°РІРєРё',
  `id_organ` smallint(5) unsigned NOT NULL COMMENT 'РћСЂРіР°РЅРёР·Р°С†РёСЏ',
...
CREATE TABLE `removeakt` (
  ...
  `removeakt_date` date NOT NULL COMMENT 'Р”Р°С‚Р° СЃРЅСЏС‚РёСЏ РјР°С‚РµСЂРёР°Р»Р°',
  `id_remover` smallint(5) unsigned NOT NULL COMMENT 'Р”РµРјРѕРЅС‚РёСЂРѕРІС‰РёРє',
...
CREATE TABLE `schetuchet` (
  ...
  `schetuchet_kod` char(50) NOT NULL COMMENT 'РЎС‡РµС‚ СѓС‡РµС‚Р°',
  `schetuchet_name` char(255) NOT NULL COMMENT 'Р Р°СЃС€РёС„СЂРѕРІРєР° СЃС‡РµС‚Р° СѓС‡РµС‚Р°',
  PRIMARY KEY (`schetuchet_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `spismat`
--

DROP TABLE IF EXISTS `spismat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spismat` (
  `spismat_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'РќРѕРјРµСЂ РІРµРґРѕРјРѕСЃС‚Рё',
  `id_mol` smallint(5) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРµ Р»РёС†Рѕ',
  `spismat_date` date NOT NULL COMMENT 'Р”Р°С‚Р° РІРµРґРѕРјРѕСЃС‚Рё',
  PRIMARY KEY (`spismat_id`),
  KEY `fk_spismat_employee1_idx` (`id_mol`),
  CONSTRAINT `fk_spismat_employee1` FOREIGN KEY (`id_mol`) REFERENCES `employee` (`employee_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `spismatmaterials`
--

DROP TABLE IF EXISTS `spismatmaterials`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spismatmaterials` (
  `spismatmaterials_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `id_spismat` mediumint(8) unsigned NOT NULL,
  `id_mattraffic` mediumint(8) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»',
  PRIMARY KEY (`spismatmaterials_id`),
  KEY `fk_spismatmaterials_spismat1_idx` (`id_spismat`),
  KEY `fk_spismatmaterials_mattraffic1_idx` (`id_mattraffic`),
  CONSTRAINT `fk_spismatmaterials_mattraffic1` FOREIGN KEY (`id_mattraffic`) REFERENCES `mattraffic` (`mattraffic_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_spismatmaterials_spismat1` FOREIGN KEY (`id_spismat`) REFERENCES `spismat` (`spismat_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `spisosnovakt` (
  `spisosnovakt_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT 'РќРѕРјРµСЂ Р·Р°СЏРІРєРё РЅР° СЃРїРёСЃР°РЅРёСЏ РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `spisosnovakt_date` date NOT NULL COMMENT 'Р”Р°С‚Р° Р·Р°СЏРІРєРё',
  `id_schetuchet` smallint(5) unsigned NOT NULL COMMENT 'РЎС‡РµС‚ СѓС‡РµС‚Р°',
  `id_mol` smallint(5) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»СЊРЅРѕ-РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРµ Р»РёС†Рѕ',
  `id_employee` smallint(5) unsigned DEFAULT NULL COMMENT 'РРЅРѕРµ РѕС‚РІРµС‚СЃС‚РІРµРЅРЅРѕРµ Р»РёС†Рѕ',
...
CREATE TABLE `spisosnovmaterials` (
  ...
  `id_mattraffic` mediumint(8) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»СЊРЅР°СЏ С†РµРЅРЅРѕСЃС‚СЊ',
  `id_spisosnovakt` mediumint(8) unsigned NOT NULL COMMENT 'Р—Р°СЏРІРєР° СЃРїРёСЃР°РЅРёСЏ РѕСЃРЅРѕРІРЅС‹С… СЃСЂРµРґСЃС‚РІ',
  `spisosnovmaterials_number` decimal(12,3) NOT NULL COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ РЅР° СЃРїРёСЃР°РЅРёРµ',
...
CREATE TABLE `tr_mat_osmotr` (
  ...
  `id_tr_mat` mediumint(8) unsigned NOT NULL COMMENT 'РњР°С‚РµСЂРёР°Р»',
  `id_osmotraktmat` mediumint(8) unsigned NOT NULL COMMENT 'РђРєС‚ РѕСЃРјРѕС‚СЂР° РјР°С‚РµСЂРёР°Р»Р°',
  `tr_mat_osmotr_comment` varchar(400) DEFAULT NULL COMMENT 'РћРїРёСЃР°РЅРёРµ РїСЂРёС‡РёРЅС‹ РЅРµРёСЃРїСЂР°РІРЅРѕСЃС‚Рё',
  `id_reason` smallint(5) unsigned DEFAULT NULL COMMENT 'РџСЂРёС‡РёРЅР° РЅРµРёСЃРїСЂР°РІРЅРѕСЃС‚Рё',
  `tr_mat_osmotr_number` decimal(12,3) unsigned NOT NULL DEFAULT '1.000' COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ РѕСЃРјРѕС‚СЂРµРЅРЅРѕРіРѕ РјР°С‚РµСЂРёР°Р»Р°',
...
CREATE TABLE `tr_osnov` (
  ...
  KEY `tr_osnov_id_cabinet` (`id_cabinet`),
  ...
  CONSTRAINT `tr_osnov_id_cabinet` FOREIGN KEY (`id_cabinet`) REFERENCES `cabinet` (`cabinet_id`)
...
CREATE TABLE `tr_rm_mat` (
  ...
  `id_removeakt` mediumint(8) unsigned NOT NULL COMMENT 'РђРєС‚ РґРµРјРѕРЅС‚РёСЂРѕРІР°РЅРёСЏ РјР°С‚РµСЂРёР°Р»СЊРЅРѕР№ С†РµРЅРЅРѕСЃС‚Рё',
...
CREATE TABLE `traflog` (
  ...
  `id_logreport` int(10) unsigned NOT NULL,
  `traflog_filename` char(255) NOT NULL COMMENT 'РРјСЏ С„Р°Р№Р»Р°',
  `traflog_rownum` mediumint(9) NOT NULL COMMENT 'РќРѕРјРµСЂ СЃС‚СЂРѕРєРё',
  `traflog_type` tinyint(1) NOT NULL COMMENT 'РўРёРї СЃРѕРѕР±С‰РµРЅРёСЏ',
  `traflog_message` varchar(1000) NOT NULL COMMENT 'РЎРѕРѕР±С‰РµРЅРёРµ',
  `mattraffic_number` decimal(12,3) DEFAULT NULL COMMENT 'РљРѕР»РёС‡РµСЃС‚РІРѕ (Р—Р°РґРµР№СЃС‚РІРѕРІР°РЅРЅРѕРµ РІ РѕРїРµСЂР°С†РёРё)',
...
) ENGINE=InnoDB AUTO_INCREMENT=36260 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-12-11 12:35:15
