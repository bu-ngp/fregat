...
INSERT INTO `cabinet` VALUES (1,8,'101'),(2,8,'102'),(3,9,'102'),(4,9,'103');
...
INSERT INTO `material` VALUES (34,'Шкаф для одежды','Шкаф для одежды',NULL,'1000001','ABCD123','2005-01-01',1.000,1200.15,1,0,851,1,'admin','2016-11-21 22:57:39',1,1,NULL),(35,'Кухонный стол','Кухонный стол',NULL,'1000002','','2010-05-01',1.000,15000.00,1,0,852,1,'admin','2016-11-21 22:59:37',1,1,NULL),(36,'Шкаф для медикаментов','Шкаф для медикаментов',NULL,'1000003','',NULL,1.000,5000.00,1,0,851,1,'admin','2016-11-21 23:27:38',1,1,NULL);
INSERT INTO `mattraffic` VALUES (1,'2016-11-22',1.000,34,1175,'admin','2016-11-22 08:57:48',1,NULL),(2,'2016-11-22',1.000,35,1176,'admin','2016-11-22 08:59:45',1,NULL),(3,'2016-11-22',1.000,36,1177,'admin','2016-11-22 09:27:38',1,NULL),(4,'2016-12-12',1.000,35,1176,'admin','2016-12-12 13:32:47',3,NULL);
INSERT INTO `installakt` VALUES (1,'2016-12-12',1176);
INSERT INTO `tr_osnov` VALUES (1,1,4,1);
...
ALTER TABLE `employee` AUTO_INCREMENT = 1179;
ALTER TABLE `osmotrakt` AUTO_INCREMENT = 1;