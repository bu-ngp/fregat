...
INSERT INTO `material` VALUES (34,'Шкаф для одежды','Шкаф для одежды',NULL,'1000001','ABCD123','2005-01-01',1.000,1200.15,1,0,851,1,'admin','2016-11-21 12:57:39',1,1,NULL),(35,'Кухонный стол','Кухонный стол',NULL,'1000002','','2010-05-01',1.000,15000.00,1,0,852,1,'admin','2016-11-21 12:59:37',1,1,NULL),(36,'HP LJ 1022','HP LJ 1022',NULL,'1000003','',NULL,1.000,3500.00,1,0,853,1,'admin','2016-12-15 05:01:23',1,1,''),(37,'Картридж А12','Картридж А12',NULL,'1000004','',NULL,1.000,750.00,2,0,854,1,'admin','2016-12-15 05:02:04',1,1,'');
INSERT INTO `mattraffic` VALUES (1,'2016-11-22',1.000,34,1175,'admin','2016-11-22 08:57:48',1,NULL),(2,'2016-11-22',1.000,35,1176,'admin','2016-11-22 08:59:45',1,NULL),(3,'2016-12-15',1.000,36,1178,'admin','2016-12-15 15:01:23',1,NULL),(4,'2016-12-15',1.000,37,1178,'admin','2016-12-15 15:02:04',1,NULL),(5,'2016-12-15',1.000,35,1176,'admin','2016-12-15 16:05:43',3,NULL),(6,'2016-12-15',1.000,34,1175,'admin','2016-12-15 16:05:58',3,NULL),(7,'2016-12-15',1.000,36,1178,'admin','2016-12-15 16:06:37',3,NULL),(8,'2016-12-15',1.000,37,1178,'admin','2016-12-15 16:07:00',4,NULL);
INSERT INTO `installakt` VALUES (1,'2016-12-15',1176),(2,'2016-12-15',1176);
INSERT INTO `tr_osnov` VALUES (1,1,1,5),(2,2,1,6),(3,3,2,7);
INSERT INTO `tr_mat` VALUES (1,2,8,7);
INSERT INTO `reason` VALUES (1,'СЛОМАНА НОЖКА'),(2,'СЛОМАНА ПОЛКА'),(3,'ТРЕБУЕТСЯ ЗАПРАВКА');
INSERT INTO `osmotrakt` VALUES (1,'',1,1178,1176,'2016-12-15',1),(2,'',2,1177,1176,'2016-12-15',2);
INSERT INTO `osmotraktmat` VALUES (1,'2016-12-15',1176);
INSERT INTO `tr_mat_osmotr` VALUES (1,1,1,'',3,1.000);
INSERT INTO `organ` VALUES (1,'РОГА И КОПЫТА','karpovvv@mugp-nv.ru','123456'),(2,'ФИРМА','','');
ALTER TABLE `recoverysendakt` AUTO_INCREMENT = 1;