 ...
 * @property string $os_material_schetuchet_kod
 * @property string $os_material_schetuchet_name
 ...
 * @property string $mat_material_izmer_kod_okei
 ...
 * @property string $gu_material_schetuchet_kod
 * @property string $gu_material_schetuchet_name
 */
class Importconfig extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['os_startrow', 'mat_startrow', 'os_filename', 'os_mattraffic_date', 'os_material_1c', 'os_material_inv', 'os_material_name1c', 'os_material_price', 'os_employee_fio', 'os_dolzh_name', 'os_podraz_name', 'os_material_serial', 'os_material_release', 'os_material_status', 'os_material_schetuchet_kod', 'os_material_schetuchet_name', 'mat_filename', 'mat_material_1c', 'mat_material_inv', 'mat_material_name1c', 'mat_material_number', 'mat_izmer_name', 'mat_material_price', 'mat_employee_fio', 'mat_dolzh_name', 'mat_podraz_name', 'mat_material_schetuchet_kod', 'mat_material_schetuchet_name','mat_material_izmer_kod_okei', 'mat_material_tip_nomenklaturi', 'logreport_reportcount', 'emp_filename', 'max_execution_time', 'memory_limit', 'gu_material_1c', 'gu_material_inv', 'gu_material_name1c', 'gu_material_serial', 'gu_material_release', 'gu_material_number', 'gu_material_price', 'gu_podraz_name', 'gu_employee_fio', 'gu_dolzh_name', 'gu_filename', 'gu_startrow', 'gu_material_schetuchet_kod', 'gu_material_schetuchet_name', 'importconfig_do'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'os_material_schetuchet_kod' => 'Позиция колонки "Счет учета" основных средств',
            'os_material_schetuchet_name' => 'Позиция колонки "Наименование счета учета" основных средств',
            ...
            'mat_material_schetuchet_kod' => 'Позиция колонки "Счет учета" материалов',
            'mat_material_schetuchet_name' => 'Позиция колонки "Наименование счета учета" материалов',
            'mat_material_izmer_kod_okei' => 'Позиция колонки "Код ОКЕИ единицы измерения" материалов',
            ...
            'gu_material_schetuchet_kod' => 'Позиция колонки "Счет учета" группового учета основных средств',
            'gu_material_schetuchet_name' => 'Позиция колонки "Наименование счета учета" группового учета основных средств',
        ];
    }
