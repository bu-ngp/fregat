...
class LogreportController extends Controller
{
    ...
    /**
     * Displays a single Logreport model.
     * @param string $id
     * @return mixed
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->logreport_id]);
        } else {
    ...
    /**
     * Updates an existing Logreport model.
    ...
    /**
     * Deletes an existing Logreport model.
