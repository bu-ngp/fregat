...
class MattrafficController extends Controller
{
    ...
    /**
     * Displays a single Mattraffic model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new Mattraffic model.
    ...
    /**
     * Updates an existing Mattraffic model.
    ...
    /**
     * Deletes an existing Mattraffic model.
