...
class RemoveaktController extends Controller
{
    ...
    /**
     * Displays a single Removeakt model.
     * @param string $id
     * @return mixed
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->removeakt_id]);
        } else {
    ...
    /**
     * Updates an existing Removeakt model.
    ...
    /**
     * Deletes an existing Removeakt model.
