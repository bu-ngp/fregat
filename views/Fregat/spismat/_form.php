            ...
            'columns' => Proc::DGcols([
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($model) {
                            return '<a data-pjax="0" href="' . Url::to(['Fregat/material/update', 'id' => $model->idMattraffic->id_material]) . '">' . $model->idMattraffic->idMaterial->material_name1c . '</a>';
                        }
                    ],
            ...
            <div class="panel-heading">
                <div class="btn-toolbar">
                    ...
                    if (!$model->isNewRecord) {
                        ...
                        echo Html::button('<i class="glyphicon glyphicon-list"></i> Скачать акты установки', ['id' => 'DownloadInstallakts', 'class' => 'btn btn-info', 'onclick' => 'DownloadReport("' . Url::to(['Fregat/spismat/spismat-installakts']) . '", $(this)[0].id, {id: ' . $model->primaryKey . '} )']);
                    }
                    ?>
                </div>
            </div>
